...
## Overview
This pipeline automates RNA-seq processing, assembly, refinement, quality assessment, and functional annotation using containerised tools executed via Singularity.
